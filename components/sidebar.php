...
include_once $_SERVER['DOCUMENT_ROOT'] . '/test2.0/php/db_connection.php';
?>
...
<aside class="sidebar">
    ...
    <div class="sidebar-content">
        <nav class="sidebar-menu">
            <a href="/GSO System/php/dashboard.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/GSO System/php/equipment/equipment.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/GSO System/php/borrowings/borrowings.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <?php if (isAdmin()): ?>
            <a href="/GSO System/php/categories/categories.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/test2.0/php/users/users.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <a href="/test2.0/php/reports.php" class="sidebar-link">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="user-profile" id="userProfile">
        ...
        <div class="user-menu-dropdown" id="userMenuDropdown">
            <?php if (!isAdmin()): ?>   
                <a href="../php/borrowings/my_borrowings.php">My Borrowings</a>
            <?php endif; ?>
